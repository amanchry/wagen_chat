...
CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1:8000/','https://wagen.waterinag.org','http://65.108.77.67:3007', 
                        ...
                        'https://india.waterinformatics.org']
...
CORS_ALLOWED_ORIGINS = [
     ...
     'https://zambia.waterinformatics.org','https://kenya.waterinformatics.org','https://mashreq.waterinformatics.org', 'https://india.waterinformatics.org'
]
